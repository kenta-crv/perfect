          ...
          <div class="container-table ">
            <p class="register-label">
              ...
              <hr class="register-label-horizontal">
                ...
                <form method="post" action="{{ route('requestinformation.save') }}">
                  @csrf
                    ...
                    <ul class="mgn-ato">
                        ...
                        <div class="display-inline--flex">
                          ...
                          <div class="rgt-bx mgn-l-20">
                            <span>
                              ...
                              @foreach($inputRequest['status'] as $key => $status)
                              <span>
                                {{ $status }}
                              </span>
                              <br>
                                <input placeholder="" type="text" hidden class="hp-input" value="{{ $key }}" name="status[{{ $key }}]">
                              @endforeach
                              @else
                              <span>-------</span>
                              @endif
                      ...
                      <li class="mgn-t-3">
                        <div class="display-inline--flex">
                          ...
                          <div class="rgt-bx mgn-l-20">
                            <span>
                              {{ $inputRequest['inquiry'] }}
                            </span>
                            <input placeholder="" type="text" hidden class="hp-input" value="{{ $inputRequest['inquiry'] }}" name="body"   >
                          </div>
                        </div>
                      </li>
                    </ul>
