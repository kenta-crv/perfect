              ...
              <form action="{{ route('register.confirmRegister') }}" method='POST'>
                ...
                <div class="l-12 l-12--gap24">
                  ...
                  <div class="l-12__6">
                    <div class="c-input ">
                      <div class="c-input c-input--full_40">
                        <select name="license_slct" class="lbl-gray dft-input-hp keep-slct-01" placeholder="選択してください">
                  ...
                  <div class="l-12__3 alg-i-c-rs">
                    <button class="c-lbl-plain hp-button fa-solid btn-right-2" for="">
                      免許がないので問い合わせる
                    </button>
                  </div>
                </div>
                ...
                <div class="l-12 l-12--gap24">
                  ...
                  <div class="l-12__9">
                    <div class="c-input c-input--full_40">
                      <input  placeholder="半角英数記号が使えます。6文字以上、32文字以内。"  type="password" name="password" class="hp-input">
                    </div>
                ...
                <div class="l-12 l-12--gap24">
                  ...
                  <div class="l-12__9 mgn-t-3">
                    <div class="p-list__item__data" style="overflow-wrap: break-word;">
                      <input name="usage_plan" type="radio" value="1" @if(old('usage_plan') == '1') checked @endif/>
                      <p class="label-radio">スターター 月額　3,000円</p>
                      <input name="usage_plan" type="radio" value="2" @if(old('usage_plan') == '2') checked @endif/>
                ...
                <div class="l-12 l-12--gap24">
                  ...
                  <div class="l-12__9 mgn-t-3">
                    <div class="p-list__item__data" style="overflow-wrap: break-word;">
                      <input name="payment_method"  type="radio" value="1" @if(old('payment_method') == '1') checked @endif /><p class="label-radio"> 銀行の口座引落</p>
                      <input name="payment_method"  type="radio" value="2" @if(old('payment_method') == '2') checked @endif /><p class="label-radio"> クレジットカード</p>
                      <input name="payment_method"  type="radio" value="3" @if(old('payment_method') == '3') checked @endif /><p class="label-radio">銀行振込</p><br/>
