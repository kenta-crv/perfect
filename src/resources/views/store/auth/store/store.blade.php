            ...
            <div class="container-table ">
                ...
                <form action="{{ route('register.head.confirm') }}" method='POST'>
                  ...
                  <div class="l-12 l-12--gap24">
                    ...
                    <div class="l-12__6">
                      <div class="c-input c-input--full_40">
                        <input type="text" name="company_name" placeholder=" 株式会社 ロボレ" class="hp-input">
                      </div>
                  ...
                  <div class="l-12 l-12--gap24">
                    ...
                    <div class="l-12__9">
                      <div class="c-input c-input--full_40">
                        <input type="text" name="address" placeholder="東京都◯◯区◯◯ビル名" class="hp-input">
                    </div>
                  ...
                  <div class="l-12 l-12--gap24">
                    ...
                    <div class="l-12__3">
                      <div class="c-input c-input--full_40">
                        <input type="text" name="tel" placeholder="0123-456-7890" class="hp-input">
                      </div>
                  ...
                  <div class="l-12 l-12--gap24">
                    ...
                    <div class="l-12__3">
                      <div class="c-input c-input--full_32">
                        <input placeholder="姓" class="no-radius hp-input" name="last_name" type="text" value="">
                      </div>
                      <span class="text-danger"> @error('last_name') {{ $message }} @enderror </span>
                    </div>
                    <div class="l-12__3">
                      <div class="c-input c-input--full_32">
                        <input placeholder="名" name="first_name" type="text" value="" class="hp-input">
                      </div>
                  ...
                  <div class="l-12 l-12--gap24">
                    ...
                    <div class="l-12__9">
                      <div class="c-input c-input--full_40">
                        <input type="email" name="email" placeholder="sample000@mail.com" class="hp-input">
                    </div>
