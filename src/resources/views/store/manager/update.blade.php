...
@component('admin.component._p-index')
  @slot('body')
    ...
    <div class="c-main-box active-cont">
        <form action="{{ route('storeAdmin.manager.mypage.update', ["id" => $mail->id]) }}"method="post">
            ...
            <div class="c-main-body">
                ...
                @endif
                    <li class="p-list__item p-list__item--center --login">
                        ...
                        <div class="c-input c-input--full">
                            <input type="text" name="name" value="{{ $mail->name }}" class="input--login mgn-r-2" contenteditable="true">
                        </div>
                    ...
                    <li class="p-list__item p-list__item--center --login">
                        ...
                        <div class="p-list__item__data" style="overflow-wrap: break-word;">
                        <div class="c-input c-input--full">
                            <input class="input--login" type="email" value="{{ $mail->email }}" name="email" placeholder="" >
                        </div>
                ...
                <div class="foot_3">
                    <div class="p-login__buttonArea">
                        <button type="submit" class="c-lbl-white-3">保存</button>
                    </div>
                </div>
            </div>
        </form>
