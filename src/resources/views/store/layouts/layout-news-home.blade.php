  ...
  <body id="body">
    <div class="l-frame">
      ...
      <div class="l-frame__row">
        {{--  @if ($current_route == 'store/search/list' || $current_route =='store' || $current_route == 'store/search' || $current_route == 'store/search/details' || $current_route == 'store/news' || $current_route == 'store/news/*' )
    ...
    @include('store.layouts._footer_news')
      </div>
    </div>
