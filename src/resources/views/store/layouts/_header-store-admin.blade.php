      ...
      <ul class="p-header__list">
        ...
        <li class="p-header__list__item">
          <p class="p-header__list__item__name">
           <a href="{{ route('storeAdmin.news.index') }}"> 
              <span class="notification_bell_icon">

              </span>
              <div class="notification_badge">
                @if(session()->get('unreads') > 0)
                  <span class="badge"><span class="badge_value">{{ session()->get('unreads') }}</span></span>
                @else
                  <span class="badge" style="visibility: hidden;"><span class="badge_value">{{ session()->get('unreads') }}</span></span>
                @endif
              </div>
          ...
          <div class="dropdown">
            ...
            <div id="myDropdown" class="dropdown-content dropdown-content-add">              
              ...
              @elseif(Helper::getStoreId() == 1)
                ...
                <a href="https://liff.line.me/1645278921-kWRPP32q/?accountId=154sxjhi" target="_blank">ロボレスタッフに連絡</a>
                <a href="/store/manager/mypage">マイページ</a>
                <a href="/store/faq">よくある質問</a>
              @endif
