        ...
        <div class="checkbox-distribution">
          <div class="checkbox-center-2">
            <div class="button-width">
              <a href="{{route('index')}}"><button class="c-lbl-white-5 margin--10-dormant" for="">TOPへ戻る</button></a>
            </div>
          </div>
        </div>
    </div>
