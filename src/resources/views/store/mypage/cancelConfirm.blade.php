...
@section('title', $title ?? '解約確認')
@section('content')

@component('admin.component._p-index')
  @slot('body')
    <div class="a-page-title">
      <span><strong style="color: #003a16;"></strong>解約手続き確認</span>
    </div>
    <div class="c-main-box active-cont">
        <div class="c-main-body">
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">このお手続きをするとアカウントが削除されます。</span>
            </div>
          </div><br/><br/>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-bold">【解約最終確認】</span>
            </div>
          </div>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">本当に解約いたしますか？</span>
            </div>
          </div>
          <br/><br/>
        </div>
        <div class="checkbox-distribution">
          <div class="checkbox-center-2">
            <div class="button-width">
              <a href="{{ route('storeAdmin.setting.cancelComplete') }}"><button class="c-lbl-white-5 margin--10-dormant" for="">解約する</button></a>
            </div>
          </div>
        </div>
    </div>
