@extends('store.layouts.layout-store-admin-dormant')
@section('title', $title ?? '休眠完了')
@section('content')

@component('admin.component._p-index')
  @slot('body')
    <div class="margin-top--7 mgn-l-4">
      <b>休眠手続き完了</b>
    </div> 
        ...
        <div class="c-main-body">
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">休眠となり機能が凍結されました。</span>
            </div>
          </div><br/><br/>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-bold">【再開について】</span>
            </div>
          </div>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">再開は<a href="{{ route('storeAdmin.setting.restarting') }}">こちら</a>からお手続きいただけます。</span>
            </div>
          </div>
          <br/><br/>
        </div>
        <div class="checkbox-distribution">
          <div class="checkbox-center-2">
            <div class="button-width">
              <a href="{{route('storeAdmin.logout')}}"><button class="c-lbl-white-5 margin--10-dormant" for="">TOPへ戻る</button></a>
            </div>
          </div>
        </div>
    </div>
