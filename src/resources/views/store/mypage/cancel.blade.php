...
@component('admin.component._p-index')
  @slot('body')
  <form action="{{ route('storeAdmin.setting.cancelConfirm')}}" method="get" id="dormant">
    <div class="a-page-title">
      <span><strong style="color: #003a16;"></strong>解約手続き</span>
    </div>
    <div class="c-main-box active-cont">
        <div class="c-main-body">
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">このお手続きをした時から、全てのアカウント・全ての設定が消去され、一切の機能が使えなくなります。</span>
              
            </div>
          </div>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">もし今後、また使う可能性があるのでしたら、「休眠」という制度がありますので、そちらをご利用ください。</span>
            </div>
          </div><br/><br/>
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <a href="{{ route('storeAdmin.setting.dormant') }}" class="cancel-link">休眠手続きを見てみる</a>
            </div>
          </div>
        </div>
        <div class="checkbox-distribution">
          <div class="checkbox-center-2">
            <div class="button-width">
              <button class="c-lbl-white-5 margin--10-dormant" for="">解約する</button>
            </div>
          </div>
        </div>
    </div>
