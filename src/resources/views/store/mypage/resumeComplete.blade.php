        ...
        <div class="c-main-body">
          <div class="checkbox-distribution">
            <div class="checkbox-center-2">
              <span class="dormant-description">再開となり機能制限が解除されました。</span>
            </div>
          </div><br/><br/>
          <br/><br/>
        </div>
        <div class="checkbox-distribution">
          <div class="checkbox-center-2">
            <div class="button-width">
              <a href="{{Helper::getTopPage()}}"><button class="c-lbl-white-5 margin--10-dormant" for="">TOPへ戻る</button></a>
            </div>
          </div>
        </div>
    </div>
