...
@component('admin.component._p-index')
  @slot('body')
    ...
    <div class="c-main-box active-cont">
        <form method="post" action="{{ route('admin.guide.updateGuide') }}">
            <input type="hidden" name="guide_id" value="{{ $guides->id }}">
            @csrf
            <div class="c-main-body">
                <li class="p-list__item p-list__item--center --login">
                    ...
                    <div class="p-list__item__data" style="overflow-wrap: break-word;">
                      <div class="c-input c-input--full">
                        <input class="input--login" type="text" name="guide_name" value="{{ $guides->guide_name }}">
                      </div>
                ...
                <li class="p-list__item p-list__item--center --login">
                    ...
                    <div class="p-list__item__data" style="overflow-wrap: break-word;">
                      <div class="c-input c-input--full">
                        <input class="input--login" type="text" name="guide_place" value="{{ $guides->guide_place }}">
                      </div>
                ...
                <li class="p-list__item p-list__item--center --login">
                    ...
                    <div class="p-list__item__data" style="overflow-wrap: break-word;">
                        <div class="textarea-width mgn-b-2">
                            <textarea row="3" cols="1" class="admin-txt-area" placeholder="内容" name="guide_body">{{ $guides->guide_body }}</textarea>
                          </div>
