...
return [
    ...
    */
    ...
    'alpha_numemail'            => ':attributeはアルファベット数字がご利用できます。',
    'array'                => ':attributeは配列でなくてはなりません。',
    'before'               => ':attributeには、:dateより前の日付をご利用ください。',
    'before_or_equal'      => ':attributeには、:date以前の日付をご利用ください。',
    'between'              => [
        'numeric' => ':attributeは、:minから:max間で入力してください。',
    ...
    'integer'              => ':attributeは整数（最大19桁）で入力してください。',
    ...
    */
    ...
    'custom' => [
        'email' => [
            'unique' => 'そのメールアドレスとパスワードの組み合わせはすでに登録されています。',
    ...
    */
    ...
    'attributes' => [
        ...
        'tel' => '電話番号',
        'address' => '住所',
        'contract_number' => '電話番号',    
        'company_name' => '会社名',
        'telephone_no' => '電話番号',
        'prefecture' => '府県',
        'body' => '内容',
        'status1' => 'こころづかい',
        'person_in_charge' => '掛かり付けの人',
        'considerations' => 'こころづかい',
        'usage_plan' => 'ご利用プラン',
        'login_id'  => 'ログインID',
        'guide_name'  => 'ガイド名を入力',
        'guide_place'  => 'ガイドプレイスを入力',
        'guide_body'  => 'ガイド本体を入力',
        'inquiry' => 'お問い合わせ内容',
